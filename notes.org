...
** TODO revisar color del cursor insert/overwrite                       :bug:
   :PROPERTIES:
   :CREATED: [2020-03-19 dj 18:20]
   :END:
...
** TODO Moure secció cpctelera                                          :bug:
   :PROPERTIES:
...
** TODO Error en =arv/query-replace=                                    :bug:
   :PROPERTIES:
...
** TODO Desactivar =hl-line-mode= en =term=                       :annoyance:
   :PROPERTIES:
