...
- [[https://github.com/karlotness/tree-sitter.el][tree-sitter]]: An Emacs dynamic module exposing [[https://github.com/tree-sitter/tree-sitter][tree-sitter]].
  ...
  [[https://olddeuteronomy.github.io/post/a-tree-sitter-config-that-works/][Aquest post]] explica com configurar emacs 28.2 per utilitzar
  tree-sitter. No tinc clar quina de les implementacions.
