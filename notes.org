...
** TODO [#B] error amb la comanda =m= en buffers /info/                 :bug:
...
** TODO [#A] estudiar =use-package=                             :enhancement:
...
** TODO [#A] moure funcionalitat                                        :bug:
...
** TODO [#C] revisar compilació de la configuració                     :task:
...
** TODO [#C] analitzar arranc                                   :enhancement:
...
** TODO [#C] abreviatures en =abbrev=                                  :idea:
...
** TODO [#C] normalitzar rutes de fitxers                              :idea:

En alguns llocs utiltizo rutes calculades dinàmicament i en d'altres
literals. Pot ser tot dinàmic?

Definir /helpers/ per acurtar i /dotar de significat/ a les rutes, per
exemple:
...
** TODO [#C] Revisar configuració backends de company           :enhancement:
   :PROPERTIES:
...
** TODO revisar funció =grin=                                   :enhancement:
   :PROPERTIES:
...
** TODO revisar =uniquify=                                      :enhancement:
   :PROPERTIES:
...
** TODO [#C] Revisar estructura                                        :idea:
   :PROPERTIES:
...
** TODO revisar codi elisp vell                                         :bug:
   :PROPERTIES:
...
** TODO integrar =ox-twbs=                                      :enhancement:
   :PROPERTIES:
...
** TODO Ajustar face de =ace-jump-mode=                         :enhancement:
   :PROPERTIES:
...
** TODO gestionar paquets absents durant la instal·lació        :enhancement:
   :PROPERTIES:
