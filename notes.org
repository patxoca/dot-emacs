...
** TODO key shadowing al activar =flyspell-prog-mode= :annoyance:
   :PROPERTIES:
...
** TODO estudiar =smerge=                                       :enhancement:
   :PROPERTIES:
...
Emacs inclou el paquet [[file:/opt/emacs/26.2.90/share/emacs/26.2.90/lisp/progmodes/project.el.gz::;;;%20project.el%20---%20Operations%20on%20the%20current%20project%20-*-%20lexical-binding:%20t;%20-*-][project.el]], estudiar-lo.
