...
** TODO hydra per canviar la mida de les finestres                     :idea:
   :PROPERTIES:
...
** TODO /boilerplate/ al crear nous arxius
   :PROPERTIES:
...
** TODO Coniguració de =C-w=                                      :annoyance:
   :PROPERTIES:
...
** TODO Extreue =arv/template= al seu propi mòdul               :enhancement:
   :PROPERTIES:
...
** TODO bug en =pyx/electric-colon=?                                    :bug:
