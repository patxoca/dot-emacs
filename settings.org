...
El problema és que =asm-mode= no reconeix les etiquetes amb un punt i
les sagna com una instrucció. El codi següent és un advice de la
funció =asm-calculate-indentation=, que reconeix les etiquetes que
comencen per un punt i les sagna 2 espais. Cal afegir l'advice amb
