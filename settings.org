...
#+begin_src emacs-lisp :tangle yes
  (with-eval-after-load "diff-hl"
    (set-face-attribute 'diff-hl-change nil :background "#da8548")
    (set-face-attribute 'diff-hl-delete nil :background "#ff6c6b")
    (set-face-attribute 'diff-hl-insert nil :background "#98be65"))
#+end_src
