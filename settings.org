...
#+begin_src emacs-lisp :tangle yes
  ...
  (when (display-graphic-p)
    ...
    (set-face-attribute 'default nil
            ...
            :height (if (>= (x-display-pixel-height) 1080) 113 106)))
...
Vaig a provar =ripgrep= una temporada enlloc de =grin=, a veure que
tal. Clarament la velocitat de resposta és molt superior i sembla que
cobreix el meu cas d'us.
...
amb =transient= i assignar específicament la comanda =rg= a =C-ç= que
fins ara tenia assignada la comanda =arv/grin=.
