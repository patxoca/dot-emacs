...
- introspecció: obtindre les apps, els models etc. (=emacs-djira=).
...
#+begin_src emacs-lisp :tangle yes
  (use-package arv-py-django
    ...
    :commands (arv/django-mode
               arv/django-jump-to-template
               arv/django-jump-to-javascript-controller
               arv/django-jump-to-template
...
https://github.com/patxoca/emacs-djira
...
#+begin_src sh :tangle yes
  ./scripts/clone_git https://github.com/patxoca/emacs-djira.git
  ./scripts/compile_package emacs-djira
#+end_src

#+begin_src emacs-lisp :tangle yes
  (use-package emacs-djira
    :ensure nil
    :load-path "site-lisp/emacs-djira"
