...
#+begin_src emacs-lisp :tangle yes
  ...
  (setq package-archives
        '(("gnu"          . "https://elpa.gnu.org/packages/")
          ...
          ("casa"         . "http://melpa.home.lan/packages/")
...
#+begin_src emacs-lisp :tangle yes
  ...
  (when (display-graphic-p)
    ...
    (set-face-attribute 'default nil
                        ...
                        :height (if (> (x-display-pixel-height) 1080) 100 94)))
#+end_src
...
#+begin_src emacs-lisp :tangle yes
  (defun my/cpctelera-make ()
    "Intenta executar make"
    (interactive)
    (let ((project-root (locate-dominating-file default-directory "Makefile")))
      (if project-root
          (compilation-start (format "cd %s ; make" project-root)
                             t
                             (lambda (mode) "*cpctlera*"))
        (user-error "No es troba 'Makefile'"))))
#+end_src
